  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400' >
      ...
      <ul className='flex items-center gap-[50px] font-medium'> 
        <NavLink to="/" >
          <li className='py-[10px] text-lg font-semibold text-gray-800 uppercase tracking-wide cursor-pointer hover:text-primary transition-colors duration-300'>Home</li>
          <hr className='border-none outline-none h-[5px] bg-primary w-3/5 m-auto hidden md:block' />
        </NavLink>
        <NavLink to="/doctor">
          <li className='py-[10px] text-lg font-semibold text-gray-800 uppercase tracking-wide cursor-pointer hover:text-primary transition-colors duration-300'>All Doctors</li>
          <hr className='border-none outline-none h-[5px] bg-primary w-3/5 m-auto' />
        </NavLink>
        <NavLink to="/about">
          <li className='py-[10px] text-lg font-semibold text-gray-800 uppercase tracking-wide cursor-pointer hover:text-primary transition-colors duration-300'>About</li>
          <hr className='border-none outline-none h-[5px] bg-primary w-3/5 m-auto ' />
        </NavLink>
        <NavLink to="/contact">
          <li className='py-[10px] text-lg font-semibold text-gray-800 uppercase tracking-wide cursor-pointer hover:text-primary transition-colors duration-300'>Contact</li>
          <hr className='border-none outline-none h-[5px] bg-primary w-3/5 m-auto ' />
        </NavLink>
      </ul>
      <div className='flex items-center gap-[40px]'>
        {token ? (
          <div className='text-color:black flex items-center gap-[20px] cursor-pointer group relative'>
